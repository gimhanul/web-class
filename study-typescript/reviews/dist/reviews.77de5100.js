...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"enums.ts":[function(require,module,exports) {
"use strict";
...
var returningUser = document.querySelector("#returning-user");
var user = document.querySelector("#user");

function showReviewTotal(value, reviewer, isLoyalty) {
  var iconDisplay = isLoyalty === enums_1.LoyaltyUser.GOLD_USER ? "⭐" : "";
  reviewTotalDisplay.innerHTML = "review total " + value.toString() + " / last veiwed by " + reviewer + " " + iconDisplay;
}
...
},{"./enums":"enums.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
(0, utils_1.populateUser)(you.firstName, you.isReturning);
...
var currentLocation = ['London', '11:11', 17];
footer === null || footer === void 0 ? void 0 : footer.innerHTML = currentLocation[0] + ' ' + currentLocation[1] + ' ' + currentLocation[2] + ' ` ';
},{"./utils":"utils.ts","./enums":"enums.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/reviews.77de5100.js.map